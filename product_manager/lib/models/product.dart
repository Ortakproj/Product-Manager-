...
class product {
  ...
  product(this._id, this._first_name, this._last_name, this._date_of_birth, this._phone_number, this._page_number, this._id_user_created);
  product.empty(this._first_name, this._last_name, this._date_of_birth, this._phone_number, this._page_number, this._id_user_created);
